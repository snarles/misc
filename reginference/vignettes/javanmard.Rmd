---
title: "Rubustness of High-dimensional inference procedures of Javanmard and Montanari"
...
## Code by Javanmard and Montanari
...
y <- UN2[, 2]
x <- UN2[, -2]
x_false <- noised_projections(x, sigma = 0.1, q = 200)
x_aug <- cbind(x, x_false)
res <- SSLasso(as.matrix(x_aug), y, verbose = TRUE)
