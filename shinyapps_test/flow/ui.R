...
shinyUI(navbarPage("ROBUILDER", id = 'nav',
  ...
  tabPanel("Build",
    fluidRow(
      ...
      tableOutput('build_cost'),
      textInput('name', 'Name:', 'coolbot'),
      ...
      textInput('atk2_name', 'Attack 2 name:', 'Attack 2'),
      sliderInput('atk2_lv', 'Attack 2 level (0 for no attack)', min = 0, max = 10, value = 0),
      sliderInput('atk2_charge', 'Attack 2 charge time', min = 0, max = 5, value = 0),
