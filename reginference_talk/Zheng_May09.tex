...
\item<4> \textbf{Incremental null}.  (Informal explanation).  I consider adding variables one at a time; I make
  a mistake whenever I add a variable to the model which
  \emph{doesn't} improve the fit of the model (and is redundant).
If I reject multiple variables, the false rejections are the variables \emph{which were already redundant} at the
