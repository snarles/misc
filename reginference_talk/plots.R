...
matplot(res_mar(xs_pf16, ys_pf16)[1:20, 2:1], type = "o", pch = c("1", "0"), ylab = "", lwd = 3)
matplot(res_mar(xs_fMRI, ys_fMRI)[1:20, 2:1], type = "o", pch = c("1", "0"), ylab = "", lwd = 3)
matplot(res_mar(xs_HIV, ys_HIV)[1:20, 2:1], type = "o", pch = c("1", "0"), ylab = "", lwd = 3)
matplot(res_mar(xs_gal, ys_gal)[1:20, 2:1], type = "o", pch = c("1", "0"), ylab = "", lwd = 3)
...
png('res_kp_type1.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = expression(FDR), xlab = expression(alpha))
abline(0, 1, col = "red", lwd = 2)
lines(1:50/50, fdr_e(res_ks_pf16[[2]])[2 * 1:50], type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, fdr_e(res_ks_fMRI[[2]])[2 * 1:50], type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, fdr_e(res_ks_HIV[[2]])[2 * 1:50], type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, fdr_e(res_ks_gal[[2]])[2 * 1:50], type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()
...
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = "Rel. Power", xlab = expression(alpha))
lines(1:50/50, res_ks_pf16$kp[2 * 1:50, 3]/good_pf16, type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, res_ks_fMRI$kp[2 * 1:50, 3]/good_fMRI, type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, res_ks_HIV$kp[2 * 1:50, 3]/good_HIV, type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, res_ks_gal$kp[2 * 1:50, 3]/good_gal, type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()
...
png('ress_s_type1.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = expression(FP/p[0]), xlab = expression(alpha))
abline(0, 1, col = "red", lwd = 2)
lines(1:50/50, ress_s_pf16[2 * 1:50, 2]/895, type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, ress_s_fMRI[2 * 1:50, 2]/822, type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, ress_s_HIV[2 * 1:50, 2]/214, type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, ress_s_gal[2 * 1:50, 2]/157, type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()

png('ress_s_power.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = "Rel. Power", xlab = expression(alpha))
lines(1:50/50, ress_s_pf16[2 * 1:50, 3]/good_pf16, type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, ress_s_fMRI[2 * 1:50, 3]/good_fMRI, type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, ress_s_HIV[2 * 1:50, 3]/good_HIV, type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, ress_s_gal[2 * 1:50, 3]/good_gal, type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()

png('ress_c_fs_type1.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = expression(FDR), xlab = expression(alpha))
abline(0, 1, col = "red", lwd = 2)
lines(1:50/50, fdr_e(ress_cs_pf16$fs)[2 * 1:50], type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, fdr_e(ress_cs_fMRI$fs)[2 * 1:50], type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, fdr_e(ress_cs_HIV$fs)[2 * 1:50], type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, fdr_e(ress_cs_gal$fs)[2 * 1:50], type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()

png('ress_c_fs_power.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = "Rel. Power", xlab = expression(alpha))
lines(1:50/50, ress_cs_pf16$fs[2 * 1:50, 3]/good_pf16, type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, ress_cs_fMRI$fs[2 * 1:50, 3]/good_fMRI, type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, ress_cs_HIV$fs[2 * 1:50, 3]/good_HIV, type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, ress_cs_gal$fs[2 * 1:50, 3]/good_gal, type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()


png('ress_c_ss_type1.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = expression(FDR), xlab = expression(alpha))
abline(0, 1, col = "red", lwd = 2)
lines(1:50/50, fdr_e(ress_cs_pf16$ss)[2 * 1:50], type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, fdr_e(ress_cs_fMRI$ss)[2 * 1:50], type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, fdr_e(ress_cs_HIV$ss)[2 * 1:50], type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, fdr_e(ress_cs_gal$ss)[2 * 1:50], type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()

png('ress_c_ss_power.png')
plot(NA, NA, ylim = c(0, 1), xlim = c(0, 1), ylab = "Rel. Power", xlab = expression(alpha))
lines(1:50/50, ress_cs_pf16$ss[2 * 1:50, 3]/good_pf16, type = "o", ylab = "", col = cols[1], pch = "P")
lines(1:50/50, ress_cs_fMRI$ss[2 * 1:50, 3]/good_fMRI, type = "o", ylab = "", col = cols[2], pch = "F")
lines(1:50/50, ress_cs_HIV$ss[2 * 1:50, 3]/good_HIV, type = "o", ylab = "", col = cols[3], pch = "H")
lines(1:50/50, ress_cs_gal$ss[2 * 1:50, 3]/good_gal, type = "o", ylab = "", col = cols[4], pch = "G")
dev.off()
