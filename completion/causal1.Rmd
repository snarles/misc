...
Generate a low-rank matrix $(Y_0 Y_1 X)$.  Then determine $D$, the treatment assignment, as a function of $X$, by the above equation.  $Y_0$ is observed for all cases where $D = 0$ and $Y_1$ is observed for all cases $D = 1$.
